...
class SeedCars extends Command
{
    protected $signature = 'seed:cars';
    protected $description = 'Seed cars into the database';
    ...
    public function handle()
    {
        ...
        $count = 0;
        foreach ($cars as $car) {
            $existing = Car::where('numberPlate', $car['numberPlate'])->first();
            if (!$existing) {
                Car::create($car);
                $count++;
            }
        ...
        $this->info("✓ $count cars added to database!");
    }
}
